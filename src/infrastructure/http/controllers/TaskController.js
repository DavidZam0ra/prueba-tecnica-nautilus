...
/**
 * @typedef {import('express').Request & { user: { userId: string, email: string } }} AuthenticatedRequest
 */

/**
 * HTTP controller for task endpoints.
 * All handlers require prior authentication.
 */
const TaskController = {
  ...
  async create(req, res, next) {
    try {
      ...
      const ownerId = /** @type {AuthenticatedRequest} */ (req).user.userId;
